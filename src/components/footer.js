...
const Footer = () => (
  <footer
    role="contentinfo"
    className="site-footer text-center medium-text-right large-text-left"
  >
    <div className="grid-container">
      <nav className="grid-x grid-padding-x grid-padding-y">
        <div className="cell medium-shrink large-5">
          <a className="footer-logo media_link" href="http://nyc.gov/planning">
            <img
              alt="NYC DCP"
          ...
          <div className="grid-x grid-padding-x grid-padding-y">
            ...
            <div className="cell medium-auto large-auto">
              <ul className="no-bullet">
                <li>
                  <a href="https://github.com/NYCPlanning/labs-open-source-policy/blob/master/policy.md">
                    Open source policy
                  </a>
                </li>
                <li>
            ...
            <div className="cell medium-auto large-auto">
              ...
              <ul className="no-bullet">
                ...
                <li>
                  <a href="https://twitter.com/nycplanning">
                    @NYCPlanning
                  </a>
                </li>
                <li>
                  <a href="mailto:edm_dl@planning.nyc.gov">
                    edm_dl@planning.nyc.gov
                  </a>
                </li>
                <li>
                  <a href="https://github.com/nycplanning/labs-planninglabs-home/issues/new">
                    Report a bug
                  </a>
                </li>
              </ul>
