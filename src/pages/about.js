...
const AboutPage = () => (
  <Layout>
    <div className="main">
      <Hero
        title="About Enterprise Data Management"
        tagline="We manage the vast and diverse data portfolio here at the NYC Department of City Planning."
      />
      <div className="grid-container">
        <div className="grid-x grid-padding-x">
          <div className="cell large-10">
            <h2
              id="what-is-edm"
              data-magellan-target="what-is-Enterprise-Data-Management"
            >
              What is Enterprise Data Management?
            </h2>
            <p className="lead">
              Enterprise Data Management is a division of the
              {' '}
        ...
        <div className="grid-x grid-padding-x">
          <div className="cell large-11">
            <p className="lead" style={{ marginBottom: '2rem' }}>
              We are passionate about data, and everything associated with it,
              from how it’s created and documented to how it’s shared and used.
              We believe that data are foundational and we’re excited to bring
              data to the forefront at NYC Planning. Here’s what that means to us:
            </p>
          </div>
